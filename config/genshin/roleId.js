...
let roleId = {
  ...
  10000029: ["可莉", "逃跑的太阳", "Klee", "klee", "嘟嘟可", "火花骑士", "蹦蹦炸弹", "炸鱼", "放火烧山", "放火烧山真君", "蒙德最强战力", "逃跑的太阳", "啦啦啦", "哒哒哒", "炸弹人", "禁闭室", "太阳", "小太阳"],
  ...
  10000041: ["莫娜", "Mona", "mona", "穷鬼", "穷光蛋", "穷", "莫纳", "占星术士", "占星师", "讨龙真君", "半部讨龙真君", "阿斯托洛吉斯·莫娜·梅姬斯图斯", "梅姬斯图斯", "梅姬斯图斯姬"],
  10000042: ["刻晴", "Keqing", "keqing", "刻情", "氪晴", "刻师傅", "刻师父", "牛杂", "牛杂师傅", "斩尽牛杂", "免疫", "免疫免疫", "屁斜剑法", "玉衡星", "阿晴", "啊晴", "璃月雷神"],
  ...
  10000046: ["胡桃", "Hu Tao", "hu tao", "HuTao", "hutao", "Hutao", "胡淘", "往生堂堂主", "火化", "抬棺的", "蝴蝶", "核桃", "堂主", "胡堂主", "雪霁梅香", "桃子", "桃"],
  ...
  //2.0
  10000002: ["神里绫华", "Kamisato Ayaka", "Ayaka", "ayaka", "神里", "绫华", "神里凌华", "凌华", "白鹭公主", "神里大小姐", "龟", "龟龟", "乌龟"],
  ...
  //3.0
  10000069: ["提纳里", "Tighnari", "tighnari", "提那里", "驴"],
  10000067: ["柯莱", "Collei", "collei", "柯来", "科莱", "科来", "小天使"],
...
let wifeData = [
  //成女
  [10000003, 10000006, 10000007, 10000014, 10000021, 10000023, 10000024, 10000027, 10000031, 10000034, 10000037, 10000041, 10000042, 10000043, 10000044, 10000045, 10000046, 10000048, 10000051, 10000002, 10000049, 10000052, 10000054, 10000056, 10000058, 10000062, 10000063, 10000064, 10000060, 10000065, 10000101, 10000102],
  //成男
...
//活动武器
let actWeapon = ["腐殖之剑", "风花之颂", "嘟嘟可故事集", "「渔获」", "辰砂之纺锤", "证誓之明瞳", "落霞", "笼钓瓶一心"];

//皮肤
let costumes = ['海风之梦', "闪耀协奏", "纱中幽兰", "霓裾翩跹", "殷红终夜", "极夜真梦"];
